local client_functions = {
    ["engineRequestModel"] = "modelTalepEt",
    ["engineLoadIFP"] = "yukleIFP",
    ["getLowLODElement"] = "dusukLODogeDondur",
    ["dxDrawMaterialSectionLine3D"] = "",
    ["setBlipColor"] = "blipRenkDegistir",
    ["getPedStat"] = "pedStatCek",
    ["guiStaticImageLoadImage"] = "guiResimDegistir",
    ["isPlayerMapForced"] = "mapAktif",
    ["setElementFrozen"] = "ogeyiDondur",
    ["givePlayerMoney"] = "oyuncuParaVer",
    ["isConsoleActive"] = "konsolAktifse",
    ["getLightRadius"] = "isikYaricapDondur",
    ["getCamera"] = "kameraCek",
    ["setWaveHeight"] = "dalgaYuksekligiAyarla",
    ["guiGetFont"] = "guiFontDondur",
    ["guiSetFont"] = "guiFontDegistir",
    ["outputChatBox"] = "yaziEkle",
    ["setLowLODElement"] = "dusukLODogeAyarla",
    ["guiGetSize"] = "guiBoyutDondur",
    ["setLightRadius"] = "isikYaricapAyarla",
    ["fileIsEOF"] = "dosyaEOFMu",
    ["canBrowserNavigateForward"] = "tarayiciSayfaDegistirebilirMi",
    ["getVehicleUpgrades"] = "aracYukseltmeleriniDondur",
    ["getVehicleOverrideLights"] = "gecersizLambaDondur",
    ["call"] = "cagirFnk",
    ["resetSunColor"] = "gunesRengiSifirla",
    ["setVehicleDoorsUndamageable"] = "aracKapilariHasarsizlastir",
    ["setPedControlState"] = "pedKontrolDurumDegistir",
    ["engineReplaceAnimation"] = "animasyonDegistir",
    ["setVehicleOverrideLights"] = "gecersizLambaAyarla",
    ["getPickupAmmo"] = "pickupMermiDondur",
    ["getOriginalHandling"] = "orijinalHandlingDondur",
    ["xmlNodeSetAttribute"] = "xmlOznitelikDuzenle",
    ["getPedControlState"] = "pedKontrolDurumDondur",
    ["engineResetSurfaceProperties"] = "zeminOzellikleriSifirla",
    ["stopObject"] = "objeDurdur",
    ["getWaveHeight"] = "dalgaYuksekligiAl",
    ["setCameraViewMode"] = "kameraGorusSifirla",
    ["resetSkyGradient"] = "havaGradyaniSifirla",
    ["setVehicleHeadLightColor"] = "aracFarRengiDegistir",
    ["injectBrowserMouseDown"] = "tarayiciImlecTiklat",
    ["guiMemoSetCaretIndex"] = "imlecKonumDegistir",
    ["isOOPEnabled"] = "acikMiOOP",
    ["getVehicleHeadLightColor"] = "aracFarRengiDondur",
    ["setElementFrozen"] = "elemanDondur",
    ["getCameraViewMode"] = "kameraGorusDondur",
    ["fxAddWaterHydrant"] = "fxSuHidrantEkle",
    ["areTrafficLightsLocked"] = "trafikIsiklariKilitliMi",
    ["bitArShift"] = "bitArShift",
    ["setTimer"] = "zamanlayiciEkle",
    ["setElementCollidableWith"] = "ogeCarpistiginiAyarla",
    ["iprint"] = "detayliYazdir",
    ["setVehicleWindowOpen"] = "aracCaminiAc",
    ["getObjectScale"] = "objeOlcekDondur",
    ["guiEditSetMaxLength"] = "guiDuzenlemeSiniriDegistir",
    ["setWeaponAmmo"] = "silahMermiDegistir",
    ["getKeyState"] = "tusaBasiliyor",
    ["utfSeek"] = "utfKarakter",
    ["breakObject"] = "objeKir",
    ["hash"] = "sifrele",
    ["getElementVelocity"] = "ogeHiziniDondur",
    ["isBrowserLoading"] = "tarayiciYukleniyorsa",
    ["isVehicleDamageProof"] = "aracKursunGecirmezMi",
    ["xmlSaveFile"] = "xmlDosyaKaydet",
    ["setElementVelocity"] = "ogeHiziniDegistir",
    ["outputConsole"] = "konsolYazdir",
    ["getRadarAreaSize"] = "radarBolgeBoyutunuDondur",
    ["guiCreateProgressBar"] = "guiIlerlemeBarOlustur",
    ["guiSetInputMode"] = "guiGirdiModDegistir",
    ["getKeyBoundToCommand"] = "komutBindiniDondur",
    ["getProjectileType"] = "mermiTurunuDondur",
    ["setRadarAreaSize"] = "radarBolgeBoyutunuDegistir",
    ["setElementDoubleSided"] = "objeIkiTarafliligiDegistir",
    ["getTickCount"] = "tickSayisiDondur",
    ["xmlNodeGetChildren"] = "",
    ["setColPolygonPointPosition"] = "",
    ["isTransferBoxActive"] = "yuklemeKutusuAktifse",
    ["setMinuteDuration"] = "",
    ["getPedAmmoInClip"] = "",
    ["clearChatBox"] = "",
    ...
    ["getProjectileForce"] = "mermiSahibiDondur",
    ["setVehicleComponentScale"] = "aracBilesenOlceginiDegistir",
    ["next"] = "siradaki",
    ["getMinuteDuration"] = "",
    ["isElementStreamable"] = "",
    ...
    ["getVehicleOccupants"] = "aractakileriDondur",
    ["setWeaponState"] = "silahDurumuDegistir",
    ["utf8"] = "utf8",
    ["setPedAnalogControlState"] = "",
    ["getPlayerPing"] = "oyuncuGecikmesiCek",
    ["requestBrowserDomains"] = "tarayiciDomainleriniTalepEt",
    ["setElementStreamable"] = "ogeYayinlanabilirliginiDegistir",
    ["Matrix"] = "Matrix",
